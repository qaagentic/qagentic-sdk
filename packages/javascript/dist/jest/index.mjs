...
// src/jest/index.ts
var QAgenticJestReporter = class {
  constructor(globalConfig2, options = {}) {
  ...
  async onRunStart() {
    await this.reporter.startRun({
      name: `jest_${(/* @__PURE__ */ new Date()).toISOString().replace(/[:.]/g, "")}`,
...
export { Severity, Status, Step, attach, attachJson, attachScreenshot, attachText, QAgenticJestReporter as default, epic, feature, label, severity, step, story, tag };
